...
/**
 * iOS-style status bar with exact SVGs from Figma export.
 * Scaled 2.88x from 375px Figma design.
 */
export const StatusBar: React.FC<StatusBarProps> = ({ time = '9:41' }) => {
  const SCALE = 2.88;
  
  // Status bar height: 44px in Figma
