  ...
  return (
    <div
      style={{
        ...
        alignItems: 'center',
        padding: '12px 24px 8px 32px',
        backgroundColor: '#FFFFFF',
      }}
    >
      {/* Time - SF Pro Semibold */}
      <div
        style={{
          fontSize: 34,
          fontWeight: 600,
      ...
      {/* Right side icons - exact from Figma */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        {/* Cellular Connection - exact from Figma */}
        <svg width="40" height="26" viewBox="0 0 20 13" fill="none">
        ...
        {/* WiFi - exact from Figma */}
        <svg width="36" height="26" viewBox="0 0 18 13" fill="none">
        ...
        {/* Battery - exact from Figma */}
        <svg width="56" height="26" viewBox="0 0 28 13" fill="none">
